---
title: "Chapter 5: ROS 2 Services and Actions - Request-Response and Long-Running Operations"
chapter_number: "5"
module: 1
week: 3
sidebar_position: 5
...
learning_outcomes:
  - "Distinguish between topics, services, and actions in ROS 2 communication patterns"
  - "Implement ROS 2 services for synchronous request-response communication"
  - "Design and create ROS 2 actions for long-running operations with feedback"
  - "Choose appropriate communication patterns for different robot behaviors"
estimated_time: 120
tier_support:
  A: true
  B: true
...
# Chapter 5: ROS 2 Services and Actions - Request-Response and Long-Running Operations

## Why This Matters

In humanoid robots like Tesla Optimus and Figure 02, not all communication follows the continuous, asynchronous pattern of topics. Sometimes robots need to request specific services with guaranteed responses (like asking "What is the battery level?") or initiate long-running operations with ongoing feedback (like "Navigate to location X - report progress"). Services provide synchronous request-response communication for immediate queries, while actions enable complex operations with feedback, goal management, and cancellation capabilities. These communication patterns are essential for robot behaviors that require confirmation, state management, or multi-step processes with intermediate results.

## Analogy: The Restaurant Service System
...
### 1. ROS 2 Services - Synchronous Request-Response
...
### 2. ROS 2 Actions - Long-Running Operations with Feedback
...
### 3. When to Use Each Communication Pattern
...
**Exercise 5.1: Robot Service and Action Laboratory**
...
**Exercise 5.2: Real Hardware Integration**
...
**Exercise 5.3: Safety-Critical Communication**
